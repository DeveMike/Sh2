...
$stmt = $conn->prepare('
    SELECT varaukset.*, Jumpat.name, Jumpat.description, Jumpat.start_time as class_start_time, Jumpat.end_time as class_end_time, Jumpat.address, Ohjaajat.name as instructor_name
    FROM varaukset
